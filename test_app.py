...
class TestCase(unittest.TestCase):
    ...
    def test_get_actors(self):
        response = self.client().get("/actors", headers={ 
            "Authorization": "bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6IjI5UnQzalNyNFVKMkhqZFpVV25VViJ9..WWs-325WduCPVGzLjNPk4iTy-ZWKjXLA5LZdEA4LzJ_u49JraPZ7CtJxKmye8ytj8X8LyJNpz9q7jfCSseMvQ3ZnRbJV721g1tIL_Va_avO5dU4paN77Fa0fT4ttUS8qJFovbUehpLDr6VWTKz0ZG5JNdLI7LLrIwd1M-zHFwdMATmUvjsrd608c_0aBrwokqz97Zg9ig-IEnM_oHHwwi8l7A9p0TS2A_0bYFumxPPQfHDc2we1i0ppwbJsBqNFjAH5B0FUiSz3RiKcBejiLke2WeBhoADsi0KalA7Rl6AaUFZM3IJAiD6C_faEHAuwq12bUj6wdOWxI6oUI4dK1Yw"
        })
